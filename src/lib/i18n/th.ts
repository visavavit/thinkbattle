...
export const th: Dictionary = {
  ...
  "comment.attach": "แนบรูป",
  "comment.attachBusy": "กำลังอัปโหลด…",
  "comment.attachDone": "แนบรูปแล้ว",
  "comment.attachTooLarge": "รูปต้องมีขนาดไม่เกิน 5 MB",
  "comment.attachHint":
    "แนบได้ความเห็นละ 1 รูป เผยแพร่แล้วเปลี่ยนรูปไม่ได้ และถ้าความเห็นถูกซ่อน รูปจะถูกลบไปด้วย",
  "comment.attachRemove": "เอารูปออก",
  "comment.attachRemoved": "เอารูปออกแล้ว",
  ...
  "mod.confirmHideImage":
    "การซ่อนความเห็นนี้จะลบรูปที่แนบมาอย่างถาวร และการเลิกซ่อนจะไม่คืนรูปให้ ดำเนินการต่อหรือไม่",
  ...
  "auth.username": "ชื่อที่แสดง",
  "auth.usernameHint": "3–24 ตัวอักษร เป็นชื่อที่แสดงบนความเห็นของคุณ และเปลี่ยนภายหลังได้",
  "auth.usernameTaken": "ชื่อนี้ถูกใช้แล้ว",
  "auth.usernameFree": "ใช้ชื่อนี้ได้",
  "auth.errUsername": "ชื่อที่แสดงต้องมี 3–24 ตัวอักษร",
  "auth.confirmPassword": "ยืนยันรหัสผ่าน",
  "auth.errPasswordMismatch": "รหัสผ่านทั้งสองช่องไม่ตรงกัน",
  "auth.forgot": "ลืมรหัสผ่าน?",
  "auth.forgotTitle": "ตั้งรหัสผ่านใหม่",
  "auth.forgotSub": "กรอกอีเมลของคุณ แล้วเราจะส่งลิงก์สำหรับตั้งรหัสผ่านใหม่ไปให้",
  "auth.forgotSend": "ส่งลิงก์ตั้งรหัสผ่านใหม่",
  "auth.forgotSent":
    "หากอีเมลนี้มีบัญชีอยู่ ลิงก์สำหรับตั้งรหัสผ่านใหม่กำลังถูกส่งไป กรุณาตรวจสอบกล่องจดหมายและโฟลเดอร์สแปม",
  "auth.backToSignIn": "กลับไปหน้าเข้าสู่ระบบ",
  "auth.resetTitle": "ตั้งรหัสผ่านใหม่",
  "auth.resetSub": "เลือกรหัสผ่านใหม่สำหรับบัญชีของคุณ",
  "auth.resetNew": "รหัสผ่านใหม่",
  "auth.resetSave": "บันทึกรหัสผ่านใหม่",
  "auth.resetDone": "อัปเดตรหัสผ่านแล้ว คุณเข้าสู่ระบบเรียบร้อย",
  "auth.resetExpired": "ลิงก์นี้หมดอายุหรือถูกใช้ไปแล้ว กรุณาขอลิงก์ใหม่",
  "auth.resetChecking": "กำลังตรวจสอบลิงก์ของคุณ…",
  "auth.errEmailTaken": "อีเมลนี้มีบัญชีอยู่แล้ว ลองเข้าสู่ระบบแทน",
  "auth.errInvalidLogin": "อีเมลหรือรหัสผ่านไม่ถูกต้อง",
  "auth.errNotConfirmed": "กรุณายืนยันอีเมลของคุณก่อน โดยกดลิงก์ในกล่องจดหมาย",
  "auth.errRateLimited": "พยายามหลายครั้งเกินไป กรุณารอสักครู่แล้วลองใหม่",
  "auth.errGeneric": "เกิดข้อผิดพลาด กรุณาลองอีกครั้ง",
  "auth.errPasswordPwned":
    "รหัสผ่านนี้เคยปรากฏในข้อมูลที่รั่วไหลสู่สาธารณะ จึงไม่ปลอดภัยพอที่จะใช้ที่นี่ กรุณาเลือกรหัสผ่านอื่น การทำให้ยาวขึ้นไม่ช่วยแก้ปัญหานี้",
  "auth.errPasswordWeak": "รหัสผ่านนี้เดาง่ายเกินไป กรุณาเลือกรหัสผ่านอื่น",
  "auth.errSignupDisabled": "ขณะนี้ยังไม่เปิดรับสมัครบัญชีใหม่",
  "auth.passwordHint":
    "อย่างน้อย 6 ตัวอักษร ระบบจะปฏิเสธรหัสผ่านที่เคยปรากฏในข้อมูลที่รั่วไหล จึงไม่ควรใช้รหัสผ่านซ้ำกับที่อื่น",
